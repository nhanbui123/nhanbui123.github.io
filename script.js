...
$(function () {
	...
	load
		...
		.to($('.khoiload'), 0.3, { scale: 2, opacity: 0.3, ease: Power4.easeOut })
		.to($('.khoiload'), 0.4, { scale: 3, opacity: 0.3, ease: Power4.easeOut })
		.to($('.khoiload'), 0.5, { scale: 5, opacity: 0.3, ease: Power4.easeOut })
